<template>
  <center><h1 class="title w-1000 rounded-full">SKILL ME</h1></center>
   <div class="skills-section">
     <div class="skills-container">
      ...
      <div class="skills-box">
       ...
       <div class="skills-title">
       <div class="skills-img">
        <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/9/95/Vue.js_Logo_2.svg/1200px-Vue.js_Logo_2.svg.png" alt="" class="skills-icons">
        </div>
        <h3>VUE</h3>
        </div>
